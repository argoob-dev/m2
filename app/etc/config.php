...
return [
    'modules' => [
        ...
        'Alrais_Cashondelivery' => 1,
        'Alrais_CategoryListing' => 1,
        'Magento_Directory' => 1,
        'Alrais_Deals' => 1,
        'Alrais_MainMenu' => 1,
        'Alrais_MainSlider' => 1,
        'Magento_Eav' => 1,
        'Alrais_ProductDetails' => 1,
        'Magento_Customer' => 1,
        'Alrais_Quickview' => 1,
        'Alrais_Shipping' => 1,
        'Magento_Indexer' => 1,
        ...
        'Alrais_VehicleFilter' => 1,
        'Magento_Newsletter' => 1,
        'Magento_EncryptionKey' => 1,
        'Magento_Etisalatpay' => 1,
        'Magento_Fedex' => 1,
