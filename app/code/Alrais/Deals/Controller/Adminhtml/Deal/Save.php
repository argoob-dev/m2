...
namespace Alrais\Deals\Controller\Adminhtml\Deal;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Alrais\Deals\Model\ResourceModel\Deal\CollectionFactory
     */
    ...
    public function __construct(
        Context $context,
        \Magento\Backend\Helper\Js $jsHelper,
        \Alrais\Deals\Model\ResourceModel\Deal\CollectionFactory $dealCollectionFactory
    ) {
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Alrais\Deals\Model\Deal $model */
            $model = $this->_objectManager->create('Alrais\Deals\Model\Deal');
    ...
    public function saveProducts($model, $post)
    {
        ...
        if (isset($post['products'])) {
            ...
            try {
                ...
                $table = $this->_resources->getTableName(\Alrais\Deals\Model\ResourceModel\Deal::TBL_ATT_PRODUCT);
