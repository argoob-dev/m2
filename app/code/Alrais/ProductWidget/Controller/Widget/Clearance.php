...
class Clearance extends \Magento\Framework\App\Action\Action {
	...
	//changed the attribute from clearance to bestseller for testing
    ...
    private function getHtml($items){
        ...
        $iterator = 0;
        $limit = 4;
        $html  = '<div class="container"><div class="flex_block"><div class="seventy"><ul class="productlisting">';
        ...
        $html .= '</ul></div><div class="thirty cat_bg headstyle"><div><h2>'
        . __('Clearance') .'</h2><a href="'. $this->_url->getUrl().'backin' .'" class="btn">'.__('View All') .'</a></div></div>'
        .'</div></div>';
        return $html;
    }
}
