<?php
namespace Alrais\MainSlider\Block\Adminhtml\Widget;
...
//		$this->setChild('form_after', $block);
	...
	protected function _addField($parameter, $fieldset)
	{
		...
		if ($helper = $parameter->getHelperBlock()) {
			...
			$this->_coreRegistry->register('menuitems_widget_chooser', 1); // cho phep block Alrais\MainSlider\Block\Adminhtml\Widget\Chooser check widget available for megamenu
