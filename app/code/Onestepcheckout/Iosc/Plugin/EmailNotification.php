    ...
    public function beforeNewAccount(
        ...
        if ($this->helper->isEnabled()) {
            $autoRegister = $this->scopeConfig
                ->getValue('onestepcheckout_iosc/registration/autoregister', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            if ((int)$autoRegister === 1 && $this->checkoutSession->getQuote()->getIoscRegistered() < 1) {
