    ...
    function (
        ...
        return uiComponent.extend({
            ...
            initialize: function () {
                ...
                uiRegistry.async("checkout.steps.shipping-step.shippingAddress.before-form.amazon-widget-address")(
                    function (amazonAddress) {
                        amazonAddress.getShippingAddressFromAmazon = _.wrap(
           ...
           validationHandler: function () {
               ...
               if (addressListLength > 0) {
                   ...
                   self.isAmazonWidget = false;
                   uiRegistry.async("checkout.steps.shipping-step.shippingAddress.before-form.amazon-widget-address")(
                       function (amazonPayment) {
                           self.isAmazonWidget = amazonPayment.isAmazonEnabled();
                       }.bind(self)
                   );
                   if(self.isAmazonWidget === true) {
                       isValid = this.shippingAddressView.validateShippingInformation();
                   }
