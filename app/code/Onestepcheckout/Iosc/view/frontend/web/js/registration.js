...
define(
    ...
    function (uiComponent, uiRegistry, _, jQuery, ko, emailView, domObserver, additionalValidators, validator) {
        "use strict";
                ...
                uiRegistry.async("checkout.steps.shipping-step.shippingAddress.customer-email")(
                    function (emailView) {
                        ...
                        if (this.cnf.optionalpwd !== "1") {
                            emailView.checkEmailAvailability = _.wrap(emailView.checkEmailAvailability, function (originalMethod) {
                                return true;
                            });
                        }
