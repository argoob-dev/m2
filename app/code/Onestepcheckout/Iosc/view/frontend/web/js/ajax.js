        ...
        return uiComponent.extend({
            ...
            update: function () {
                ...
                storage.post(
                    ...
                    function (response) {
                            if (response.responseJSON['redirect'] !== undefined && response.responseJSON['redirect'] == window.checkoutConfig.cartUrl) {
                            } else if (response.responseJSON['message'] !== undefined && response.responseJSON['message']) {
