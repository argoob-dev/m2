...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Currency implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function renderCss()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('renderCss', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderExport(\Magento\Framework\DataObject $row)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderExport($row);
        } else {
            return $this->___callPlugins('renderExport', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function _getInputValueElement(\Magento\Framework\DataObject $row)
    {
        ...
        if (!$pluginInfo) {
            return parent::_getInputValueElement($row);
        } else {
            return $this->___callPlugins('_getInputValueElement', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderHeader()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('renderHeader', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderProperty()
    {
        ...
        if (!$pluginInfo) {
            return parent::renderProperty();
        } else {
            return $this->___callPlugins('renderProperty', func_get_args(), $pluginInfo);
        }
    }
